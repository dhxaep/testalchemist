...
require 'PHPMailer/src/SMTP.php';
          ...
          $email = $_POST['email'];
          $judul = register;
          $pesan = $_POST['first_name'],$_POST['last_name'],$_POST['school'],$_POST['email'],$_POST['area_code'],$_POST['phone'],$_POST['subject'],$_POST['exist'];
...
try {
    ...
    //pengirim
    $mail->setFrom('register@alchemist.com', 'alchemist.or.id');
